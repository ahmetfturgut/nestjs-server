...
export class ValidationPipe implements PipeTransform<any> {
  ...
  private buildError(errors) {
    const result = {};
    errors.forEach((el: { property: any; constraints: { [s: string]: unknown; } | ArrayLike<unknown>; }) => {
  ...
  private toValidate(metatype: Type<any> | ObjectConstructor | StringConstructor | BooleanConstructor | NumberConstructor | ArrayConstructor): boolean {
